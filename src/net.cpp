...
// https://github.com/transmission/miniupnpc/blob/e37cde82e8673a5e71bae43086828704fd5eeac1/miniupnpc.c#L283
    ...
    if (r == 1)
    {
        ...
        string strDesc = "VRPay " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"vrpay.thoughtwave.com", "node.vrpay.thoughtwave.com"},
    {"vrpay.thoughtwave.com", "node2.vrpay.thoughtwave.com"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("vrpay-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. VRPay is probably already running."), addrBind.ToString().c_str());
        else
